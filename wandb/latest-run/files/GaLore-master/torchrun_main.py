...
def evaluate_model(model, preprocess_batched, pad_idx, global_rank, world_size, device, batch_size):
    _time = time.time()
    # local_val_data_path = "../c4/en/"  
    # validation_files = glob.glob(os.path.join(local_val_data_path, "c4-validation.*.json.gz"))
...
def main(args):
    ...
    if global_rank == 0:
        wandb.init(project="galore-c4", mode='offline')
    ...
    # train_path = '../c4/en/'
    # train_files = sorted(glob.glob(os.path.join(train_path, "c4-train.*-of-*.json.gz")))
